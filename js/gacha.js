var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.threeStarCats.push(new Cat("Fishing Cat", 1, "Aqua", "Fishing is this cat's favorite hobby. However, the pond that this cat frequents is actually a hot spring.", "☆☆☆", new Skill("Catch of the day?", "Recovers a small amount of HP for all cats within 500 range of this unit.", 2), 15, 16, 22, 8, "fishingCat", "fishingCatCircle"));
        ...
        this.fiveStarCats.push(new Cat("Mecha Cat", 1, "Anemo", "This cat does not know how to operate this machinery at all. Be careful.", "☆☆☆☆☆", new Skill("Bullet Hell", "Inflicts massive AOE damage to all opponents within 850 range. Damage is increased for every cat within 850 range of the unit.", 3), 17, 39, 13, 5, "mechaCat", "mechaCatCircle"));
        ...
        this.fiveStarCats.push(new Cat("Hesitant Cat", 1, "Light", "Its master demanded it to leap off a cliff and fly high to reach the stars above. However, as cats lack the wings for flight, this cat is hesitant to take that leap of faith.", "☆☆☆☆☆", new Skill("Have some Courage!", "Inflicts 18% of last enemy target's current HP as damage to the last enemy target. If there are at least 2 cat allies nearby, damage is increased from 18% to 50%.", 1), 28, 29, 26, 3, "hesitantCat", "hesitantCatCircle"));
        this.fiveStarCats.push(new Cat("Sushi Master Cat", 1, "Terra", "This cat has trained for over 500 years to make the world's finest sushi.", "☆☆☆☆☆", new Skill("All You Can Eat", "Fully recovers HP for cats within 850 range. Applies 'Satisfied' status to all cats within 850 range for 1 turn.", 5), 48, 13, 38, 10, 'sushiMasterCat', 'sushiMasterCatCircle'));
