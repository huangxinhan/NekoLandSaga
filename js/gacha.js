var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.threeStarCats.push(new Cat("Fishing Cat", 1, "Aqua", "Fishing is this cat's favorite hobby. However, the pond that this cat frequents is actually a hot spring.", "☆☆☆", new Skill("Catch of the day?", "Recovers a small amount of HP for all cats within 500 range of this unit.", 3), 15, 16, 22, 8, "fishingCat", "fishingCatCircle"));
