var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.fourStarCats.push(new Cat('Scientist Cat', 1, "Genius of the century, accidently discovered the secrets of the universe!", "☆☆☆☆", new Skill("Toxic Chemicals", "Inflicts 'Poison' status on the last enemy target.", 1), 30, 30, 1, 5, 'scienceCat', 'scienceCatCircle'));
        this.fourStarCats.push(new Cat("Sumo Cat", 1, "This immovable legendary cat is the world's greatest sumo master... as well as the world's most famous competitive eater.", "☆☆☆☆", new Skill("Immmovable Rock", "Inflicts 'Iron Wall' status on itself for 5 turns. Recovers 50% HP.", 10), 100, 28, 36, 9, 'sumoCat', 'sumoCatCircle'));
        this.fourStarCats.push(new Cat("Billionaire Cat", 1, "This is the richest cat ever. Pretty sure his name is Henry or something. This is the only cat that can afford shoes. If you ask kindly, he may even give you three dollars.", "☆☆☆☆", new Skill("Tax Evasion", "Activating this skill will yield a +20% cat food reward increase for completing the current stage.", 20), 30, 25,  25, 3, 'billionaireCat', 'billionaireCatCircle'));
        this.fourStarCats.push(new Cat('Knight Cat', 1, "This cat somehow found some knight armor and a sword, then believed that it is a knight...", "☆☆☆☆", new Skill("Sword that cuts through any Armor", "Inflicts 'Rage' Status on itself for 1 turn.", 2), 30, 50, 50, 6, "knightCat", "knightCatCircle"));
        ...
        this.fiveStarCats.push(new Cat("Wizard Cat", 1, "This wizard cat is about to summon a demon... or so it believed.", "☆☆☆☆☆", new Skill("Dark Summoning Arts", "Upon activating the skill, revives a random fallen cat.", 30), 20, 40, 6, 3, "wizardCat", "wizardCatCircle"));
        this.fiveStarCats.push(new Cat("Hesitant Cat", 1, "Its master demanded it to leap off a cliff and fly high to reach the stars above. However, as cats lack the wings for flight, this cat is hesitant to take that leap of faith.","☆☆☆☆☆", new Skill("With the power of Friendship!", "Inflicts 20% of last enemy target's current HP as damage to the last enemy target.", 1), 30, 25, 16, 5, "hesitantCat", "hesitantCatCircle" ));
