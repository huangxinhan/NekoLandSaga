var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.threeStarCats.push(new Cat("Homeowner Cats", 1, "Through Billionaire Cat's 'Donate a Home' program, these lucky cats are able to secure their own cardboard house!", "☆☆☆", new Skill("Home Sweet Home", "Inflicts 'Iron Wall' status on itself for 1 turn. Recovers 25% HP.", 3), 23, 14, 20, 10, "homeownerCats", "homeownerCatsCircle"));
