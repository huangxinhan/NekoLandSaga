var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.threeStarCats.push(new Cat("Jogging Cat", 1, "This cat is practicing for the annual Cat Marathon sponsored by Rich Cat. If he wins 1st place, he can finally get a pair of running shoes.", "☆☆☆", new Skill("Building up Stamina", "Upon activating the skill, unit can start its move phase again. (This move phase is treated as one turn)", 5), 30, 12, 13, 5, 'joggingCat', 'joggingCatCircle'));
        this.threeStarCats.push(new Cat("Chainsaw Cat", 1, "Beware of this dangerous cat (the chainsaw is likely just a toy.)", "☆☆☆", new Skill("It's a real chainsaw!", "Inflicts 'Rage' status on itself for 1 turn.", 3), 14, 16, 13, 5, "chainsawCat", "chainsawCatCircle"));
        ...
        this.threeStarCats.push(new Cat("Fishing Cat", 1, "Fishing is this cat's favorite hobby. However, the pond that this cat frequents is actually a hot spring.", "☆☆☆", new Skill("Catch of the day?", "Recovers a small amount of HP for all cats within 500 range of this unit.", 3), 50, 12, 13, 5, "fishingCat", "fishingCatCircle"));
        ...
        this.fourStarCats.push(new Cat('Knight Cat', 1, "This cat somehow found some knight armor and a sword, then believed that it is a knight...", "☆☆☆☆", new Skill("Piercing Sword", "Inflicts 'Rage' status on itself for 1 turn.", 1), 30, 50, 50, 6, "knightCat", "knightCatCircle"));
        this.fiveStarCats.push(new Cat("Mecha Cat", 1, "This cat does not know how to operate this machinery at all. Be careful.", "☆☆☆☆☆", new Skill("Bullet Hell", "Inflicts massive AOE damage to all opponents within 500 range. Damage is increased for every cat within 500 range of the unit.", 5), 100, 50, 60, 3, "mechaCat", "mechaCatCircle"));
        ...
        this.fiveStarCats.push(new Cat("Wizard Cat", 1, "This wizard cat is about to summon a demon... or so it believed.", "☆☆☆☆☆", new Skill("Dark Summoning Arts", "Increase energy count by 5 for all cats within 800 range, except for Wizard Cat", 5), 20, 40, 6, 3, "wizardCat", "wizardCatCircle"));
        this.fiveStarCats.push(new Cat("Hesitant Cat", 1, "Its master demanded it to leap off a cliff and fly high to reach the stars above. However, as cats lack the wings for flight, this cat is hesitant to take that leap of faith.","☆☆☆☆☆", new Skill("Have some Courage!", "Inflicts 18% of last enemy target's current HP as damage to the last enemy target. If there are at least 2 cat allies nearby, damage is increased from 18% to 30%.", 1), 30, 25, 16, 5, "hesitantCat", "hesitantCatCircle" ));
