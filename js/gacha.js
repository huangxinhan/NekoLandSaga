var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.fourStarCats.push(new Cat('Scientist Cat', 1, "Aqua", "Genius of the century, accidently discovered the secrets of the universe!", "☆☆☆☆", new Skill("Toxic Chemicals", "Inflicts 'Poison' status on the last enemy target for 3 turns.", 1), 20, 29, 17, 3, 'scienceCat', 'scienceCatCircle'));
        ...
        this.fiveStarCats.push(new Cat("Twin Cats", 1, "Dark", "These cats hold some kind of divine power.", "☆☆☆☆☆", new Skill("Celestial Providence", "Upon activating the skill, unit can start its move phase again. (This move phase is treated as one turn)", 2), 33, 33, 12, 1, "twinCat", "twinCatCircle"));
