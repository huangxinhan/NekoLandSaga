var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.threeStarCats.push(new Cat("Chainsaw Cat", 1, "Terra", "Beware of this dangerous cat (the chainsaw is likely just a toy.)", "☆☆☆", new Skill("It's a real chainsaw!", "Inflicts 'Rage' status on itself for 2 turns.", 3), 14, 21, 10, 5, "chainsawCat", "chainsawCatCircle"));
        ...
        this.threeStarCats.push(new Cat("Fishing Cat", 1, "Aqua", "Fishing is this cat's favorite hobby. However, the pond that this cat frequents is actually a hot spring.", "☆☆☆", new Skill("Catch of the day?", "Recovers a small amount of HP for all cats within 500 range of this unit.", 1), 15, 16, 22, 8, "fishingCat", "fishingCatCircle"));
        this.fourStarCats.push(new Cat("Chef Cat", 1, "Light", "The best chef in town, makes the best cat food!", "☆☆☆☆", new Skill("Some catfood for you!", "Recovers some HP for all cats. Applies 'Satisfied' Status to all cats.", 1), 20, 13, 26, 6, "chefCat", "chefCatCircle"));
        this.fourStarCats.push(new Cat('Scientist Cat', 1, "Aqua", "Genius of the century, accidently discovered the secrets of the universe!", "☆☆☆☆", new Skill("Toxic Chemicals", "Inflicts 'Poison' status on the last enemy target for 3 turns.", 1), 20, 26, 17, 3, 'scienceCat', 'scienceCatCircle'));
        this.fourStarCats.push(new Cat("Sumo Cat", 1, "Terra", "This immovable legendary cat is the world's greatest sumo master... as well as the world's most famous competitive eater.", "☆☆☆☆", new Skill("Immovable Rock", "Inflicts 'Iron Wall' status on itself for 5 turns. Recovers 50% HP.", 5), 27, 16, 28, 9, 'sumoCat', 'sumoCatCircle'));
        this.fourStarCats.push(new Cat("Billionaire Cat", 1, "Dark", "This is the richest cat ever. Pretty sure his name is Henry or something. This is the only cat that can afford shoes. If you ask kindly, he may even give you three dollars.", "☆☆☆☆", new Skill("Tax Evasion", "Activating this skill will yield a +20% cat food reward increase (Can be stacked).", 10), 15, 15, 15, 3, 'billionaireCat', 'billionaireCatCircle'));
        this.fourStarCats.push(new Cat('Knight Cat', 1, "Terra", "This cat somehow found some knight armor and a sword, then believed that it is a knight...", "☆☆☆☆", new Skill("Piercing Sword", "Inflicts 'Rage' status on itself for 2 turns.", 1), 25, 25, 25, 7, "knightCat", "knightCatCircle"));
        this.fiveStarCats.push(new Cat("Mecha Cat", 1, "Anemo", "This cat does not know how to operate this machinery at all. Be careful.", "☆☆☆☆☆", new Skill("Bullet Hell", "Inflicts massive AOE damage to all opponents within 850 range. Damage is increased for every cat within 850 range of the unit.", 3), 17, 39, 13, 7, "mechaCat", "mechaCatCircle"));
        this.fiveStarCats.push(new Cat("Twin Cats", 1, "Dark", "These cats hold some kind of divine power.", "☆☆☆☆☆", new Skill("Celestial Providence", "Upon activating the skill, unit can start its move phase again. (This move phase is treated as one turn)", 2), 33, 23, 12, 1, "twinCat", "twinCatCircle"));
        this.fiveStarCats.push(new Cat("Wizard Cat", 1, "Aqua", "This wizard cat is about to summon a demon... or so it believed.", "☆☆☆☆☆", new Skill("Dark Summoning Arts", "Increase energy count by 5 for all cats within 800 range, except for Wizard Cat", 5), 20, 32, 26, 3, "wizardCat", "wizardCatCircle"));
        this.fiveStarCats.push(new Cat("Hesitant Cat", 1, "Light", "Its master demanded it to leap off a cliff and fly high to reach the stars above. However, as cats lack the wings for flight, this cat is hesitant to take that leap of faith.", "☆☆☆☆☆", new Skill("Have some Courage!", "Inflicts 30% of last enemy target's current HP as damage to the last enemy target. If there are at least 2 cat allies nearby, damage is increased to 50%.", 1), 28, 29, 26, 3, "hesitantCat", "hesitantCatCircle"));
        this.fiveStarCats.push(new Cat("Sushi Master Cat", 1, "Terra", "This cat has trained for over 500 years to make the world's finest sushi.", "☆☆☆☆☆", new Skill("All You Can Eat", "Fully recovers HP for cats. Applies 'Satisfied' status to all cats within 850 range for 1 turn.", 3), 48, 13, 38, 10, 'sushiMasterCat', 'sushiMasterCatCircle'));
