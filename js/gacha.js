var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.fourStarCats.push(new Cat('Scientist Cat', 1, "Aqua", "Genius of the century, accidently discovered the secrets of the universe!", "☆☆☆☆", new Skill("Toxic Chemicals", "Inflicts 'Poison' status on the last enemy target for 3 turns.", 1), 20, 23, 17, 3, 'scienceCat', 'scienceCatCircle'));
