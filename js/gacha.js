var GachaScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.fourStarCats.push(new Cat("Sumo Cat", 1, "Terra", "This immovable legendary cat is the world's greatest sumo master... as well as the world's most famous competitive eater.", "☆☆☆☆", new Skill("Immovable Rock", "Inflicts 'Iron Wall' status on itself for 5 turns. Recovers 50% HP.", 3), 27, 16, 28, 9, 'sumoCat', 'sumoCatCircle'));
        ...
        this.fiveStarCats.push(new Cat("Mecha Cat", 1, "Anemo", "This cat does not know how to operate this machinery at all. Be careful.", "☆☆☆☆☆", new Skill("Bullet Hell", "Inflicts massive AOE damage to all opponents within 850 range. Damage is increased for every cat within 850 range of the unit.", 2), 17, 39, 13, 7, "mechaCat", "mechaCatCircle"));
        ...
        this.fiveStarCats.push(new Cat("Wizard Cat", 1, "Aqua", "This wizard cat is about to summon a demon... or so it believed.", "☆☆☆☆☆", new Skill("Dark Summoning Arts", "Increase energy count by 5 for all cats within 800 range, except for Wizard Cat", 3), 20, 32, 26, 3, "wizardCat", "wizardCatCircle"));
